(function(){
    ...
    //Please note this can be hosted in a .css file on the localhost and pointed to in the 'var style ='
    ...
    //returns url in format /page1/page2/path1234.html
    ...
    function createRequest(requestUrl, config) {
        ...
        xhr.addEventListener("load", function () {
            ...
            // Closes the div when "closeMe" div is clicked
